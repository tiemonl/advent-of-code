...
@AocProblem(year = 2021, day = 23, name = "Amphipod")
class Problem23(
    inputProvider: InputProvider = fileInputProvider<Problem23>()
) : Problem<Int, Int>() {
    val rawInput = inputProvider.provideStringListInput()
    override val input = rawInput

    private val initialState = State.from(rawInput)
    private val initialStatePart2 =
        State.from(rawInput.take(3) + "  #D#C#B#A#  " + "  #D#B#A#C#  " + rawInput.takeLast(2))
    ...
    override fun solvePartTwo(): Int {
        return organizeAmphipods(initialStatePart2)
    }
