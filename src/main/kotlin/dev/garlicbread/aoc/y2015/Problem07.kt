...
class Problem07(
    ...
    private fun parseInstruction(instruction: Instruction, command: List<String>, partTwo: Boolean = false): Unit = when (command.size) {
    ...
    private fun Int.complement() = this.toString(2).padStart(16, '0').map { if (it == '0') '1' else '0' }.joinToString("").toInt(2)
}
